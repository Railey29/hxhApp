      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContainer}>
          <CustomImage
            ...
            duration={800}
            source={require("../assets//images/Chrollo.jpg")}
            width={imageWidth}
            height={imageHeight}
            resizeMode="contain"
            ref={imageRef}
          ...
          <Animatable.Text
            ...
            ref={textRef}
          >
            In Hunter x Hunter (HxH), Specialization is a Nen ability type that
            allows a user to develop unique abilities that do not fit into the
            other five Nen categories. Essentially, a Specialist’s Nen can have
            unusual or unpredictable effects that are completely original to the
            user.
          </Animatable.Text>
          <Animatable.Text
            animation="slideInLeft"
            ...
            ref={textRef}
          >
            Specialization (特質系, Tokushitsu-kei) – A Nen ability type in
            which the user has unique powers that fall outside Enhancement,
            Transmutation, Emission, Conjuration, and Manipulation. These
            abilities often have special conditions or extraordinary effects.
          </Animatable.Text>
          <CustomButton
            title="Start Quiz"
            onPress={() =>
