...
export default function ConjurationSCreen() {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContainer}>
          <CustomImage
            ...
            duration={800}
            source={require("../assets//images/Kurapika.jpg")}
            width={imageWidth}
            height={imageHeight}
            resizeMode="contain"
            ref={imageRef}
          ...
          <Animatable.Text
            ...
            ref={textRef}
          >
            In Hunter x Hunter (HxH), Conjuration is a Nen ability type that
            allows a user to create objects out of their aura, giving it new
            forms or properties. Essentially, a Conjurer can make their aura
            take the shape of a tangible item, weapon, or tool that can interact
            with the environment or opponents.
          </Animatable.Text>
          <Animatable.Text
            animation="slideInLeft"
            duration={800}
            ...
            ref={textRef}
          >
            Conjuration (具現化系, Gugenka-kei) – A Nen ability type in which
            the user materializes their aura into objects. These objects can
